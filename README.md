...
A project meant to learn from and teach others on how to code a full stack application from complete scratch and get it deployed! Functionally it'll be a simple note taking app (cause let's face it, todo lists are booooring) with a DnD theme added to it.
